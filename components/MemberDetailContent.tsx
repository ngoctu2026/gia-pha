        ...
        >
          <div>
            <h1 className="text-2xl sm:text-3xl font-serif font-bold text-stone-900 flex items-center gap-2 sm:gap-3 flex-wrap">
              ...
              {lineageRole && (
                <span className="text-[10px] sm:text-xs font-sans font-bold rounded-md px-2 py-0.5 whitespace-nowrap shadow-xs border text-blue-700 bg-blue-50/60 border-blue-200/60 uppercase tracking-wider">
                  {lineageRole}
                </span>
              )}
            </h1>
            ...
            {lineageRole && (
              <p className="mt-1 text-xs text-stone-500">
                Xác định theo giới tính trong nhóm anh/chị/em: ưu tiên
                birth_order, nếu thiếu sẽ đối chiếu ngày sinh sớm hơn.
              </p>
            )}
