...
-- Governance documents: tộc quy, tộc ước, quy định
...
DROP TRIGGER IF EXISTS tr_clan_documents_updated_at ON public.clan_documents;
CREATE TRIGGER tr_clan_documents_updated_at
  BEFORE UPDATE ON public.clan_documents
  FOR EACH ROW EXECUTE PROCEDURE public.handle_updated_at();

DROP TRIGGER IF EXISTS tr_clan_finance_entries_updated_at ON public.clan_finance_entries;
CREATE TRIGGER tr_clan_finance_entries_updated_at
...
DROP TRIGGER IF EXISTS tr_clan_news_updated_at ON public.clan_news;
CREATE TRIGGER tr_clan_news_updated_at
  BEFORE UPDATE ON public.clan_news
  FOR EACH ROW EXECUTE PROCEDURE public.handle_updated_at();

-- Site-wide configuration (logo, footer and branding)
