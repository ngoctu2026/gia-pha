...
export default async function DashboardLaunchpad() {
  ...
  const publicFeatures = [
    ...
    },
    {
      ...
      description: "Quản lý quy ước, tộc quy và các quy định chung",
      icon: <ScrollText className="size-8 text-indigo-600" />,
      href: "/dashboard/clan",
    ...
    },
    {
      ...
      description: "Theo dõi thu chi và số dư quỹ của dòng họ",
    ...
    },
    {
      ...
      description: "Đăng thông báo họp họ, lễ giỗ và hoạt động khuyến học",
      icon: <Megaphone className="size-8 text-orange-600" />,
      href: "/dashboard/news",
  ...
  const adminFeatures = [
    ...
    },
    {
      ...
      description: "Tùy chỉnh logo và thông tin footer của website",
      icon: <Settings className="size-8 text-amber-600" />,
